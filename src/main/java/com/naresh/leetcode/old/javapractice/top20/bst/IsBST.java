package com.naresh.leetcode.old.javapractice.top20.bst;
...
/*
	...
	*/
	public static boolean isBST3(TreeNode root) {
		return auxBST32(root, Integer.MIN_VALUE, Integer.MAX_VALUE);
	}
	...
	private static boolean auxBST32(TreeNode root, int min, int max) {
		...
		boolean b = auxBST32(root.left, min, root.data);
		boolean c = auxBST32(root.right, root.data, max);
		if(b&&c) {
		    return true;
		}
		return false;
