package com.naresh.leetcode.old.javapractice.top20.dp;

public class CountSteps {

    /*
     * //TC:O(3^n) SC:O(n) pure recursion public static long countSteps1(int n) {
     * if(n == 1) return 1; if(n == 2) return 2; if(n == 3) return 4; long prev1 =
     * countSteps1(n-1); long prev2 = countSteps1(n-2); long prev3 =
     * countSteps1(n-3); return prev1 + prev2 + prev3; }
     */
