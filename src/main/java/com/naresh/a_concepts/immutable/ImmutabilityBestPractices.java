...
public class ImmutabilityBestPractices {
    ...
    public static void main(String[] args) {
        ...
        ImmutablePerson immutablePerson = new ImmutablePerson("Maria", gradesList);
        ...
        try {
            ...
            System.err.println("add() UnsupportedOperationException - immutable list");
        }
 ...
 */
record ImmutablePerson(String name, List<Integer> grades) {
    /**
