...
public class VerticalOrderBtreeHash {
		...
		// Utility function to store vertical order in map 'm' 'hd' is horizontal distance of current node from root.'hd' is initially passed as 0
